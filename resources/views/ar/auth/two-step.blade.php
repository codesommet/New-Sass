                            ...
                            <div class="card border-0 p-lg-3 shadow-lg rounded-2">
                                ...
                                <div class="card-body">
                                    <div class="mb-3 text-center">
                                        <span><i class="isax isax-security-user text-primary fs-48"></i></span>
                                    </div>
                                    <div class="text-center mb-3">
                                        <h5 class="mb-2">المصادقة الثنائية</h5>
                                        <p class="mb-0">أدخل الرمز من تطبيق المصادقة الخاص بك</p>
                                    </div>
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="btn bg-primary-gradient text-white w-100">تحقق</button>
                                    </div>

                                    <div class="text-center mt-3">
                                        <p class="mb-0">
                                            <a href="{{ route('login') }}" class="text-primary">استخدام طريقة
                                                أخرى</a>
                                        </p>
                                    </div>
                                </div>
